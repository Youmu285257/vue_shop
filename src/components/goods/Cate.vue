<template>
  <div>
      ...
      <el-form :model="addCateForm" :rules="addCateFormRules" ref="addCateFormRef" label-width="100px">
        ...
        <el-form-item label="父级分类：">
          ...
          <el-cascader v-model="selectedKeys" :options="parentCateList"
            :props="{ expandTrigger: 'hover', ...cascaderProps, }" @change="parentCateChanged" clearable>
          </el-cascader>
        </el-form-item>
      </el-form>
    ...
    <!-- 修改分类对话框 -->
    <el-dialog title="修改角色" :visible.sync="editCateDialogVisible" width="50%" @close="editCateDialogClosed">
